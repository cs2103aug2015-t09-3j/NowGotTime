...
public class CommandEditTest extends CommandTest {
    ...
    public void testCanEditEvent() throws Exception {
        ...
        new CommandEditItem(name, CommonHelper.FIELD_START, "19 Jan 2016").execute(service, project, history);
        ...
        new CommandEditItem(name, CommonHelper.FIELD_START, "20 Sep 2016 13:00").execute(service, project, history);
        event = service.viewSpecificEvent(name);
        assertEquals(event.getStartDateTimeString(), "20 Sep 2016 13:00");
        
        // test can edit end date
        new CommandEditItem(name, CommonHelper.FIELD_END, "19 Dec 2016").execute(service, project, history);
        event = service.viewSpecificEvent(name);
        ...
        new CommandEditItem(name, CommonHelper.FIELD_END, "20 Nov 2016 15:00").execute(service, project, history);
        event = service.viewSpecificEvent(name);
    ...
    public void testCanEditTodo() throws Exception {
        ...
        new CommandEditItem(name, CommonHelper.FIELD_DUE, "19 Dec 2016").execute(service, project, history);
        ...
        new CommandEditItem(name, CommonHelper.FIELD_DUE, "20 Nov 2016 13:00").execute(service, project, history);
        todo = service.viewSpecificTask(name);
