	...
	public boolean deleteTaskWithDeadline(String taskName) {
		for (Todo task:taskBookWithDeadline){
			if (task.getName().equals(taskName)){
				...
				taskHandler.saveEditedTodoHandler(task.getDeadlineDate(), taskBookWithDeadline);
				return true;
			}
		}
		return false;
	...
	public boolean editTaskNameWithDeadline(String taskName, String newTaskName) {
		...
		for (Todo task:taskBookWithDeadline){
			if (task.getName().equals(taskName)){
				...
				taskHandler.saveEditedTodoHandler(_task.getDeadlineDate() ,taskBookWithDeadline); 
				return true;
			}
			else {
