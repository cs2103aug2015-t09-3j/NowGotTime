...
//private static final String EVENT_OVERVIEWER = "todoOverviewer.txt";
//	
...
//	private ArrayList<Todo> currentWorkingMonthFile = new ArrayList<Todo>();
//	
//	
///*****************************************************************************************/		
//
...
//	}
//
//	public boolean saveNewEventHandler(Todo todo){
//		if(todo.hasDate()){
//			Calendar Date = todo.getDeadline();
//			
//		}
//		else{
...
//		
//		ArrayList<Todo> todoBook  = new ArrayList<Todo>();
//		String todoName, todoDate, addInfo;
//		
//		try {
...
//				
//				Todo todo = new Todo(todoName, addInfo, todoDate);
//				todoBook.add(todo);
//			}
//			
//			reader.close();		 
